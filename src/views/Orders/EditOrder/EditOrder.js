...
class EditOrder extends Component {
  ...
  toggleCollapse = (e, i) => {
    e.preventDefault();
    const newArray = this.state.collapse.map((element, index) => {
                    ...
                    <CardBody>
                      ...
                      <Row className="mt-3">
                        <Col md="6">
                          <Card style={{ borderRadius: "0px" }}>
                            <CardHeader style={{ fontFamily: "inherit" }}>
                              <span className="h5">General Details</span>
                              <div className="card-header-actions">
                                {/*eslint-disable-next-line*/}
                                <a
                                  className="card-header-action btn btn-minimize"
                                  data-target="#collapseExample"
                                  onClick={(e) => this.toggleCollapse(e, 0)}
                                >
                                  <i
                                    className={
                        ...
                        <Col md="6">
                          <Card style={{ borderRadius: "0px" }}>
                            <CardHeader style={{ fontFamily: "inherit" }}>
                              <span className="h5">Order Actions</span>
                              <div className="card-header-actions">
                                {/*eslint-disable-next-line*/}
                                <a
                                  className="card-header-action btn btn-minimize"
                                  data-target="#collapseExample"
                                  onClick={(e) => this.toggleCollapse(e, 1)}
                                >
                                  <i
                                    className={
